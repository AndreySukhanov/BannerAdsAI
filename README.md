...
4. **Выберите шрифт** заголовка (Roboto, Inter, Montserrat, Open Sans)
5. **Выберите заголовок** из 3 сгенерированных вариантов (90-100 символов)
6. **Отредактируйте заголовок** при необходимости (нажмите на иконку редактирования)
7. **Получите готовые баннеры** и скачайте их в формате PNG
...
### v2.1.0 - Редактирование заголовков, выбор шрифтов и улучшенная обработка ошибок
